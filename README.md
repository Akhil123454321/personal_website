...
1. add redirection -- write a message and redirect it to my email
2. implement modification function  
~~10. fix `ctrl-c` functionality~~
1.  Implement a `manual` command --> provides instructions/documentation on how to use the website
2.  Convert into an application where other people can make their own profiles